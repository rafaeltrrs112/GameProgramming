...
public class DrawableLogicMapper {
	...
	public DrawableLogicMapper() {
		...
		//TODO
		logicClassMap.put(EntityFactory.LIGHT_TYPE,new Drawable() {public void draw(Batch batch, Entity entity, float parentAlpha) {}}); //Empty drawable for not checking on null
	}
