...
public class Image9patchVO extends MainItemVO {
    ...
    public void loadFromEntity(Entity entity) {
        ...
        NinePatchComponent ninePatchComponent = entity.getComponent(NinePatchComponent.class).get();
        DimensionsComponent dimensionsComponent = entity.getComponent(DimensionsComponent.class).get();
