...
import com.badlogic.ashley.core.signals.Listener;
...
public class Engine {
	private static Family empty = Family.all().get();
	 ...
	 final Listener<Entity> componentAdded = new ComponentListener();
	 final Listener<Entity> componentRemoved = new ComponentListener();
	
	SystemManager systemManager = new SystemManager(new EngineSystemListener());
	 EntityManager entityManager = new EntityManager(new EngineEntityListener());
	 ComponentOperationHandler componentOperationHandler = new ComponentOperationHandler(new EngineDelayedInformer());
	 FamilyManager familyManager = new FamilyManager(entityManager.getEntities());
	 boolean updating;
	...
	protected void addEntityInternal(Entity entity) {
		...
		entity.orientationHandlerSet(componentOperationHandler);
	...
	protected void removeEntityInternal(Entity entity) {
		...
		entity.orientationHandlerSet(null);
	}
